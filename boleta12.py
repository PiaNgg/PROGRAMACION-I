...
primer_producto = input ( " INGRESO EL NOMBRE DEL PRIMER PRODUCTO: " )
segundo_producto = input ( " INGRESO EL NOMBRE DEL SEGUNDO PRODUCTO: " )
...
unidades_1 = int ( input ( " INGRESO EL NUMERO DE UNIDADES DEL PRIMER PRODUCTO: " ))
unidades_2 = int ( input ( " INGRESO EL NUMERO DE UNIDADES DEL SEGUNDO PRODUCTO: " ))
